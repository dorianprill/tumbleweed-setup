...
packages="htop gparted hardinfo wine winetricks lutris vlc code gcc git gh helix inkscape xournalpp texlive texlive-latexmk texlive-pgf texlive-biblatex texlive-biber texlive-beamer texlive-beamertheme-metropolis texlive-listings texlive-listingsutf8 texlive-csquotes texlive-multirow texlive-tcolorbox texlive-babel-german texlive-german"
